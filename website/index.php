...
<main>
    ...
    <nav class="navbar">
        ...
        <div><a href="teams/register_team.php">Register your own team</a></div>
...
if (isset($_SESSION['user_id']) && checkUserRegistration($pdo, $user_id)){
    // Database connection
...
// Select input for register form
    ...
    echo 'Log in to register and participate in the fun!';
} else if(!checkUserRegistration($pdo, $user_id)){
    echo 'You are already registered, get ready to play';
}
    ?>
